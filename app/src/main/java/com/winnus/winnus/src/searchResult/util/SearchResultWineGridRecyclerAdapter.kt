...
class SearchResultWineGridRecyclerAdapter(private var context: Context, val items: List<RetrieveWineRes>, val viewInterface : SearchResultActivityView): RecyclerView.Adapter<SearchResultWineGridRecyclerAdapter.ViewHolder>() {
