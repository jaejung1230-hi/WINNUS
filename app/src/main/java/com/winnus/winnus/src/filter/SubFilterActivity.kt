...
class SubFilterActivity : com.winnus.winnus.config.BaseActivity<ActivityFilterBinding>(ActivityFilterBinding::inflate) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.seekBarAcidity.progress = com.winnus.winnus.config.ApplicationClass.FilterBoolean.acidityGlobal
        binding.seekBarBody.progress = com.winnus.winnus.config.ApplicationClass.FilterBoolean.bodyGlobal
        binding.seekBarSugarContent.progress = com.winnus.winnus.config.ApplicationClass.FilterBoolean.sweetnessGlobal
        binding.seekBarTannin.progress = com.winnus.winnus.config.ApplicationClass.FilterBoolean.tanninGlobal
